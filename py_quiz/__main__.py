...
class Application(tk.Frame):
	...
	'''
        tkMessageBox.showinfo("About MCQ!","Welcome to MCQ! v0.3\n MCQ is developed to explore Tkinter and then started off as a simple application.\nMCQ! is maintained at \nhttps://github.com/sujithps/MCQ/ \n\nYour contributions and suggestions are welcome. Feel free to fork and pull changes to MCQ! The application is open-source and is open for development.\n\nMCQ is developed and maintained by Sujith PS. For suggestions and changes, feel free to drop an email:\n abhijit[dot]nathwani[at]gmail[dot]com .\n\nInitial Release: Sept '17.")

    def confirm_quit(self):
	'''
	Function to confirm quit when the player presses Quit Button. If yes, Quit the application, If no, return to the game.
	'''
        choice = tkMessageBox.askyesno('Quit Application','Are you sure you wish to stop playing MCQ! ?')
        if choice == True:
            self.quit()
        elif choice == False:
            pass
